================================================================================
    MFC 라이브러리 : MFC_Exp01 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 MFC_Exp01 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 MFC_Exp01 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
MFC_Exp01.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CMFC_Exp01App 응용 프로그램
    클래스를 선언합니다.

MFC_Exp01.cpp
    응용 프로그램 클래스 CMFC_Exp01App이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\MFC_Exp01.ico
    ...
    주 리소스 파일인 MFC_Exp01.rc에 의해 포함됩니다.
...
MFC_Exp01Doc.h, MFC_Exp01Doc.cpp - 문서
    이 파일에는 CMFC_Exp01Doc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CMFC_Exp01Doc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

MFC_Exp01View.h, MFC_Exp01View.cpp - 문서 뷰
    이 파일에는 CMFC_Exp01View 클래스가 들어 있습니다.
    CMFC_Exp01View 개체는 CMFC_Exp01Doc 개체를 보는 데 사용됩니다.

res\MFC_Exp01Doc.ico
    CMFC_Exp01Doc 클래스의 MDI 자식 창에 대한 아이콘으로 사용되는
    아이콘 파일입니다. 이 아이콘은 주 리소스 파일인 MFC_Exp01.rc에
    의해 포함됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 MFC_Exp01.pch와
